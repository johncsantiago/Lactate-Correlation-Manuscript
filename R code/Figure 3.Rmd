...
<br  /><br  /><br  />
***Postively and Negatively Correlating Gene Figures***<br  />
All genes with pre-perfusion expression that has >80% correlation with lactate levels observed at 3 hours of NMP and expression over 0 CPM in all libraries and over 5 TPM in at least one library.


<br  /><br  /><br  />
***Figure 3A***<br  />
Heatmap of genes that meet positive correlation with lactate criteria<br  />
```{r echo=F, fig.height=11, fig.width=7}
...
probe.tpm=apply(TPM,1,max)
cordata=intersect(cordata,names(probe.tpm[probe.tpm>5]))
