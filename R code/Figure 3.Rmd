---
title: "Lactate Correlation Paper"
...
x=LTD$time[LTD$libraryID==names(FG)[1]&LTD$time!=0&LTD$time<=6]
y=LTD$alactate[LTD$libraryID==names(FG)[1]&LTD$time!=0&LTD$time<=6]
...
i=2
while(i<=length(FG)){
  x=LTD$time[LTD$libraryID==names(FG)[i]&LTD$time!=0&LTD$time<=6]
  y=LTD$alactate[LTD$libraryID==names(FG)[i]&LTD$time!=0&LTD$time<=6]
